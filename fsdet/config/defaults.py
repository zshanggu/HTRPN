...
# Threshold to determine the potential objects
_C.MODEL.PROPOSAL_GENERATOR.POTENTIAL_THRESHOLD = 0.5
# Threshold to determine the potential objects
_C.MODEL.PROPOSAL_GENERATOR.IS_FINE_TUNING = False
# Whether to use contrastive learning for RPN
_C.MODEL.PROPOSAL_GENERATOR.IS_CONTRAST = False
